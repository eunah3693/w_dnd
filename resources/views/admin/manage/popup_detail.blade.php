                ...
                <div class="block block-rounded">
                    ...
                    <div class="block-content">
                        <div class="form-group form-row">
                            ...
                            <div class="col-4">
                                <label>팝업위치</label>
                                <select class="form-control form_position" disabled name="page">
                        ...
                        <div class="form-group text-right">
                            <a type="" href="/admin/manage/popup_modify?idx=@isset($data){{ $data->idx }}@endisset" class="btn btn-dark">수정</a>
                            <a type="" href="/admin/manage/popup" class="btn btn-dark">취소</a>
                        </div>
                    </div>
                </div>
            </form>
