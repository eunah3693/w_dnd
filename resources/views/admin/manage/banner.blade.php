            ...
            <div class="block block-rounded">
                <div class="block-header block-header-default">
                    <h3 class="block-title">전체 배너리스트</h3>
                        <div class="block-options"  onclick="location.href='/admin/manage/banner_modify'">
                ...
                <div class="block-content">
                            ...
                            {{-- 검색창 --}}
                            <form action="/admin/manage/banner" method="get" >
                        ...
                        <table class="table table-borderless table-striped table-vcenter" id="table_list" data-table="banner">
                            ...
                            <tbody>
                                ...
                                <tr >
                                    ...
                                    <td class="d-sm-table-cell text-center font-size-sm">{{ $val->page }} {{ $val->position }}</td>
                                    <td class="font-w600 cursor" onclick="location.href='/admin/manage/banner_detail?idx={{ $val->idx }}'">{{ $val->title }}</td>
                                    ...
                                    <td class="d-xl-table-cell text-center font-size-sm  cursor" onclick="location.href='/admin/manage/banner_modify?idx={{ $val->idx }}'"><i class="si si-pencil fa-fw"></i></td>
        ...
        function updatePublic(idx, type)
            {
                ...
                $.post('/api/admin/banner/visible', data, function(res){
                    if(res.status == 200)
                    {
                        alert(res.msg);
                        location.reload();
            ...
            function deleteData(idx)
            {
                if(confirm('삭제하시겠습니까?'))
                {
                    ...
                    $.post('/api/admin/manage/banner/delete', data, function(res){
                        if(res.status == 200)
                        {
                            alert(res.msg);
                            location.reload();
