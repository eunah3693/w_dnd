...
<form method="POST" action="{{ $url }}">
                    ...
                    <div class="block block-rounded">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">경험치 {{ $type }}</h3>
                                        ...
                                        <tr>
                                            <td class="text-center font-size-sm">
                                                <span class="text-gray-darker font-w600">
                                                    <span><input name="user_idx" value="{{ $exp->user_idx }}"></span>
                                                    <input name="exp_idx" type="hidden" value="{{ $exp->idx }}">
                                                </span>
                                            </td>
                                            <td class="d-none d-sm-table-cell text-center font-size-sm"><span><input name="exp" type="number" value="{{ $exp->exp }}"></span></td>
                                            <td class="d-none d-sm-table-cell text-center font-size-sm" style="padding-left:20px"><span><input name="memo" type="text" value="{{ $exp->memo }}"></span></td>
