    ...
    <div class="block block-rounded">
        <form action="{{ $type }}{{ $data->idx }}" method="post">
            ...
            <div class="block-header block-header-default" style="position: relative;">
                <h3 class="block-title">공지 {{ $title }}</h3>
            ...
            <div class="block-content">
                <div class="form-group form-row">
                    <div class="col-8">
                        <label>공지글 제목</label> <input type="text" name="title" class="form-control" value="@isset($data->title){{$data->title}}@endisset">
                    </div>
                    <div class="col-4 "></div>
                ...
                <div class="form-group form-row">
                    <div class="col-8 ">
                        <div class="custom-control custom-switch custom-control-light custom-control-lg">
                            <label>상단고정</label>
                            <input type="checkbox" class="custom-control-input" id="top_fixed" name="top_fixed" value="1" {{ $data->hidden == '1' ? 'checked="checked"' : '' }}>
